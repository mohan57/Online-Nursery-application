...
public class explore4 extends JPanel implements ActionListener{
...
l1=new JLabel("ANY WEATHER PLANTS");
...
l2=new JLabel("PEACE LILY    (Rs:140)");
l2.setBounds(200,200,180,50);
l2.setFont(fo2);


l3=new JLabel("MOGRA  (Rs:125)");
l3.setBounds(200,350,180,50);
l3.setFont(fo2);

l4=new JLabel("BEGONIA   (Rs:70)");
l4.setBounds(200,500,150,50);
l4.setFont(fo2);

l5=new JLabel("IMPATIENCE    (Rs:85)");
l5.setBounds(200,650,180,50);
l5.setFont(fo2);

l6=new JLabel("GERENIUM    (Rs:100)");
l6.setBounds(615,200,180,50);
l6.setFont(fo2);

l7=new JLabel("VINCA    (Rs:65)");
l7.setBounds(615,350,150,50);
l7.setFont(fo2);

l8=new JLabel("MARIGOLD   (Rs:40)");
l8.setBounds(615,500,150,50);
l8.setFont(fo2);

l9=new JLabel("SALVIA    (Rs:145)");
...
public void paintComponent(Graphics g)
{
      ...
      g1.setColor(Color.BLACK);
       ...
       Image img1 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/pl.png");
       g1.drawImage(img1,91,204,this); 
        
       Image img2 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/mogra.png");
       g1.drawImage(img2,91,355,this);
 
       Image img3 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/begonia.png");
       g1.drawImage(img3,91,505,this); 
      
       Image img4 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/impatience.png");
       g1.drawImage(img4,91,656,this); 

      Image img5 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/gerenium.png");
       g1.drawImage(img5,505,204,this); 
      
     Image img6 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/vinca.png");
       g1.drawImage(img6,505,355,this); 

    Image img7 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/marigold.png");
       g1.drawImage(img7,505,505,this); 


   Image img8 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/salvia.png");
