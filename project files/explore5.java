...
public class explore5 extends JPanel implements ActionListener{
...
l2=new JLabel("IVY    (Rs:120)");
l2.setBounds(200,200,150,50);
l2.setFont(fo2);


l3=new JLabel("FICUS  (Rs:135)");
l3.setBounds(200,350,180,50);
l3.setFont(fo2);

l4=new JLabel("PATHOS    (Rs:200)");
l4.setBounds(200,500,150,50);
l4.setFont(fo2);

l5=new JLabel("HEARTLEAF    (Rs:220)");
l5.setBounds(200,650,180,50);
l5.setFont(fo2);

l6=new JLabel("ARECA    (Rs:90)");
l6.setBounds(615,200,150,50);
l6.setFont(fo2);

l7=new JLabel("WATERBAMBOO   (Rs:95)");
l7.setBounds(615,350,180,50);
l7.setFont(fo2);

l8=new JLabel("PASSIONFLOWER (Rs:135)");
l8.setBounds(615,500,180,50);
l8.setFont(fo2);

l9=new JLabel("OXALIX    (Rs:140)");
...
public void paintComponent(Graphics g)
{
      ...
      g1.setColor(Color.BLACK);
       ...
       Image img1 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/ivy.png");
       g1.drawImage(img1,91,204,this); 
        
       Image img2 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/ficus.png");
       g1.drawImage(img2,91,355,this);
 
       Image img3 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/pathos.png");
       g1.drawImage(img3,91,505,this); 
      
       Image img4 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/hl.png");
       g1.drawImage(img4,91,656,this); 

      Image img5 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/areca.png");
       g1.drawImage(img5,505,204,this); 
      
     Image img6 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/wb.png");
       g1.drawImage(img6,505,355,this); 

    Image img7 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/ps.png");
       g1.drawImage(img7,505,505,this); 


   Image img8 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/oxalix.png");
...
if(c6.isSelected())
{
data+="WATER BAMBOO  : 95rs\n";
a+=95; 
}

if(c7.isSelected())
{
data+="PASSION FLOWER : 135rs\n";
a+=135; 
}
