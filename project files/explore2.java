...
public class explore2 extends JPanel implements ActionListener{
...
l1=new JLabel("RARE/IMPORTED PLANTS");
...
l2=new JLabel("A.SNAPSHOT    (Rs:300)");
l2.setBounds(200,200,180,50);
l2.setFont(fo2);


l3=new JLabel("COLEUS KONG (Rs:250)");
l3.setBounds(200,350,180,50);
l3.setFont(fo2);

l4=new JLabel("HOLLAND ALOE  (Rs:400)");
l4.setBounds(200,500,1800,50);
l4.setFont(fo2);

l5=new JLabel("MICROCARPA   (Rs:375)");
l5.setBounds(200,650,180,50);
l5.setFont(fo2);

l6=new JLabel("LOBELIA    (Rs:351)");
l6.setBounds(615,200,150,50);
l6.setFont(fo2);

l7=new JLabel("ROSEMERC   (Rs:230)");
l7.setBounds(615,350,180,50);
l7.setFont(fo2);

l8=new JLabel("ADENIUM   (Rs:320)");
l8.setBounds(615,500,150,50);
l8.setFont(fo2);

l9=new JLabel("CHRISTINA (Rs:410)");
l9.setBounds(615,650,180,50);
l9.setFont(fo2);
...
public void paintComponent(Graphics g)
{
      ...
      g1.setColor(Color.BLACK);
       ...
       Image img1 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/a.ss.png");
       g1.drawImage(img1,91,204,this); 
        
       Image img2 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/ck.png");
       g1.drawImage(img2,91,355,this);
 
       Image img3 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/wh.png");
       g1.drawImage(img3,91,505,this); 
      
       Image img4 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/fc.png");
       g1.drawImage(img4,91,656,this); 

      Image img5 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/lobelia.png");
       g1.drawImage(img5,505,204,this); 
      
     Image img6 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/rm1.png");
       g1.drawImage(img6,505,355,this); 

    Image img7 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/AO.png");
       g1.drawImage(img7,505,505,this); 


   Image img8 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/c.png");
...
if(c1.isSelected())
{
data+="SNAPSHOT(W)  : 300rs\n";
a+=300; 
}

if(c2.isSelected())
{
data+="COLEUS KONG  : 250rs\n";
a+=250; 
}

if(c3.isSelected())
{
data+="HOLLAND ALOE(W)  : 400rs\n";
a+=400; 
}

if(c4.isSelected())
{
data+="MICROCAROA : 375rs\n";
a+=375; 
}
