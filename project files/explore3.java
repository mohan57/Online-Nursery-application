...
public class explore3 extends JPanel implements ActionListener{
...
l1=new JLabel("FLOWERING PLANTS");
...
l2=new JLabel("ROSE    (Rs:30)");
l2.setBounds(200,200,150,50);
l2.setFont(fo2);


l3=new JLabel("HIBISCUSS  (Rs:30)");
l3.setBounds(200,350,180,50);
l3.setFont(fo2);

l4=new JLabel("MARIGOLD    (Rs:50)");
l4.setBounds(200,500,150,50);
l4.setFont(fo2);

l5=new JLabel("JASMINE    (Rs:45)");
l5.setBounds(200,650,150,50);
l5.setFont(fo2);

l6=new JLabel("DOWNY JASMINE  (Rs:60)");
l6.setBounds(615,200,190,50);
l6.setFont(fo2);

l7=new JLabel("IXORA   (Rs:30)");
l7.setBounds(615,350,150,50);
l7.setFont(fo2);

l8=new JLabel("ZINNIAS  (Rs:40)");
l8.setBounds(615,500,150,50);
l8.setFont(fo2);

l9=new JLabel("SUNFLOWER    (Rs:55)");
...
public void paintComponent(Graphics g)
{
      ...
      g1.setColor(Color.BLACK);
       ...
       Image img1 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/rose.png");
       g1.drawImage(img1,91,204,this); 
        
       Image img2 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/hib.png");
       g1.drawImage(img2,91,355,this);
 
       Image img3 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/marigold.png");
       g1.drawImage(img3,91,505,this); 
      
       Image img4 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/jasmine.png");
       g1.drawImage(img4,91,656,this); 

      Image img5 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/dl.png");
       g1.drawImage(img5,505,204,this); 
      
     Image img6 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/ixora.png");
       g1.drawImage(img6,505,355,this); 

    Image img7 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/zinnias.png");
       g1.drawImage(img7,505,505,this); 


   Image img8 = Toolkit.getDefaultToolkit().getImage("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/sun.png");
