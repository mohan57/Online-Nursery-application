...
ImageIcon img1=new ImageIcon("/Users/mohanthota/Eclipse.app/plant3/src/plant3/pictures/logo.png");
l4=new JLabel(img1);
...
add(t1);add(b10);add(b11);add(b12);add(b13);add(b14);add(l6);
